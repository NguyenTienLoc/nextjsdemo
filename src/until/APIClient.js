...
export default class APIClient {
  ...
  GET = async (path, params, cancelToken) => {
    return await this.request('GET', path, null, null, params, null,
      cancelToken);
  };

  POST = async (path, data, header, cancelToken) => {
    return await this.request('POST', path, header, null, null, data,
      cancelToken);
  };
  ...
  DELETE = async (path, data, cancelToken) => {
    return await this.request('DELETE', path, null, null, null, data,
      cancelToken);
  };

  paramsPOST = async (path, params, data, cancelToken) => {
    return await this.request('POST', path, null, null, params, data,
      cancelToken);
  };
  ...
  jsonPOST = async (path, data, cancelToken) => {
    ...
    return await this.request('post', path, headers, null, null, data,
      cancelToken);
  };
  ...
  jsonPUT = async (path, data, cancelToken) => {
    ...
    return await this.request('put', path, headers, null, null, data,
      cancelToken);
  };
  ...
  jsonParamsPUT = async (path, params, data, cancelToken) => {
    ...
    return await this.request('put', path, headers, null, params, data,
      cancelToken);
  };

  authPOST = async (path, auth, cancelToken) => {
    return await this.request('POST', path, null, auth, null, null,
      cancelToken);
  };
  ...
  request = async (method, path, headers, auth, params, data, cancelToken) => {
    try {
      ...
      if (_.startsWith(path, 'http')) {
        ...
        const baseURL = 'https://api.dimohi.com'
        url = baseURL + path;
      }
